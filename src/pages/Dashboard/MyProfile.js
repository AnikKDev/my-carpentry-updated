        ...
        <div className=" lg:text-left lg:mr-10">
          <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title text-2xl mb-3 text-primary">
                My Profile
              </h2>
              <p className="my-2">
              ...
              <p className="my-2">
                <span className="font-bold uppercase ">LinkedIn URL:</span>{" "}
                {userInfo?.linkedin}
              </p>
              <p className="my-2">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="relative z-0 w-full mb-6 group">
                ...
                <label
                  for="floating_email"
                  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-7 scale-75 top-1 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Email address
                </label>
              </div>
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                {errors.location?.type === "required" && (
                  <span className="text-error">Location is required</span>
                )}
              </div>
              <div className="relative z-0 w-full mb-6 group">
                <input
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                {errors.linkedin?.type === "required" && (
                  <span className="text-error">LikedIn profile required</span>
                )}
              </div>
              <div className="relative z-0 w-full mb-6 group">
                <input
