...
const Payment = () => {
    const { id } = useParams();
    const { data: item, isLoading } = useQuery(['bookingInfo', id], () => fetch(`https://whispering-sierra-85456.herokuapp.com/booking/${id}`, {
        method: 'GET',
        headers: {
            ...
            <div className="mt-20">
                <div className="card w-50 max-w-md bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">Continuing Payment For {item?.toolName}</h2>
