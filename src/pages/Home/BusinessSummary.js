...
const BusinessSummary = () => {
    return (
        <div className="my-14 py-36 summary-container" >
            <h1 className="text-4xl text-center my-5 text-primary font-bold">WE ARE THE BEST MANUFACTURER FOR CARPENTRY</h1>
            <h4 className="text-2xl text-center text-gray-500">We provide what our users need</h4>
            <div className="grid mt-10 gap-y-10 grid-cols-1 lg:grid-cols-4 justify-items-center my-7">
